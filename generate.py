...
from kinematic_bicycle_model.libs import CarDescription, SmoothRandom, generate_cubic_spline
...
class Car:
    ...
    def __init__(self, init_x, init_y, init_yaw, px, py, pyaw, delta_time):
        ...
        self.tracker = SmoothRandom(max_steer)
    ...
    def drive(self):
        ...
        acceleration = 0
        self.wheel_angle = self.tracker.generate()
